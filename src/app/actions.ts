...
export async function updatePostulacionEstado(
  id: string,
...
export async function updateProyectoEstado(id: string, estado: string) {
  return store.updateProyectoEstado(id, estado as EstadoProyecto, "Operador");
}

export async function updateProyectoResponsable(
  id: string,
  responsable: string,
) {
