...
const translations: Record<Lang, Record<string, string>> = {
  es: {
    ...
    "evaluaciones.subtitle": "Vista general de evaluaciones de proyectos",
    "evaluaciones.evaluados": "Evaluados",
    "evaluaciones.pendientes": "Pendientes",
    "evaluaciones.potencialAlto": "Potencial Alto",
    "evaluaciones.comunidadUcu": "Comunidad UCU",
    "evaluaciones.pendientesTitulo": "Proyectos pendientes de evaluación",
    "evaluaciones.evaluar": "Evaluar",
    "evaluaciones.noData": "No hay evaluaciones registradas",
    "evaluaciones.proyecto": "Proyecto",
    "evaluaciones.estado": "Estado",
    "evaluaciones.etapa": "Etapa",
    "evaluaciones.potencial": "Potencial",
  ...
  en: {
    ...
    "evaluaciones.subtitle": "Overview of project evaluations",
    "evaluaciones.evaluados": "Evaluated",
    "evaluaciones.pendientes": "Pending",
    "evaluaciones.potencialAlto": "High potential",
    "evaluaciones.comunidadUcu": "UCU community",
    "evaluaciones.pendientesTitulo": "Projects pending evaluation",
    "evaluaciones.evaluar": "Evaluate",
    "evaluaciones.noData": "No evaluations recorded",
    "evaluaciones.proyecto": "Project",
    "evaluaciones.estado": "Status",
    "evaluaciones.etapa": "Stage",
    "evaluaciones.potencial": "Potential",
  ...
  pt: {
    ...
    "evaluaciones.subtitle": "Visão geral das avaliações de projetos",
    "evaluaciones.evaluados": "Avaliados",
    "evaluaciones.pendientes": "Pendentes",
    "evaluaciones.potencialAlto": "Potencial alto",
    "evaluaciones.comunidadUcu": "Comunidade UCU",
    "evaluaciones.pendientesTitulo": "Projetos pendentes de avaliação",
    "evaluaciones.evaluar": "Avaliar",
    "evaluaciones.noData": "Nenhuma avaliação registrada",
